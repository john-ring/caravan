...
(function () {
    ...
    adaptive.provider('$speechSynthesis', function () {
        ...
        this.$get = function () {
            ...
            /**
            * @ngdoc function
            * @name adaptive.speech.$speechSynthesis#speak
            * @methodOf apdative.speech.$speechSynthesis
            *
            * @description
    ...
    adaptive.provider('$speechRecognition', function () {
        ...
        */
        this.$get = ['$rootScope', '$speechSynthesis', '$speechCorrection', function ($rootScope, $speechSynthesis, $speechCorrection) {
            ...
            */
            ...
            return {
                ...
                * var app = angular.module('myApp', ['adaptive.speech']);
                *
                * app.controller('Ctrl', function ($speechRecognition, $speechSynthesis) {
                *   $speechRecognition.onstart(function() {
                *      $speechSynthesis.speak('Yes?, How can I help you?);
                *   });
                * });
                * </pre>
                *
